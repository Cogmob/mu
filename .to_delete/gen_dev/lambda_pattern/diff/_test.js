...
// load local
require('./../shared/concat_promises'), require('./../shared/test_compare'), require('./_'),
// load regex
require('./test_data/1.yaml'), require('./test_data/2.yaml'), require('./test_data/3.yaml'), require('./test_data/4.yaml'), require('./test_data/5.yaml'), require('./test_data/6.yaml'),
// other
jspm.import('async-stacktrace'), jspm.import('wordwrap')];
module.exports = q.all(promises).spread(function (module_lodashfp, local_include_sharedconcat_promises, local_include_sharedtest_compare, local_include__, regex_test_data09yaml__test_data1yaml, regex_test_data09yaml__test_data2yaml, regex_test_data09yaml__test_data3yaml, regex_test_data09yaml__test_data4yaml, regex_test_data09yaml__test_data5yaml, regex_test_data09yaml__test_data6yaml, ERR, wordwrap) {
    ...
    var _ = function _() {
        ...
        return local_include_sharedconcat_promises('diff test', module_lodashfp.map(module_lodashfp.toPairs(regex_test_data09yaml.by_file), function (data) {
