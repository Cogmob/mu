...
// load local
require('./../shared/concat_promises'), require('./../shared/test_compare'), require('./../shared/reject'),
// load regex
require('./1_pre_ast'), require('./2_ast'), require('./3_ast_transformed'), require('./4_generated'), require('./5_display'), require('./after_data/0_path.yaml'), require('./after_data/1_pre_ast.yaml'), require('./after_data/2_ast.yaml'), require('./after_data/3_ast_transformed.yaml'), require('./after_data/4_generated.yaml'), require('./after_data/5_display.yaml'),
// other
jspm.import('async-stacktrace'), jspm.import('wordwrap')];
module.exports = q.all(promises).spread(function (module_lodashfp, local_include_sharedconcat_promises, local_include_sharedtest_compare, local_include_sharedreject, regex_15__1_pre_ast, regex_15__2_ast, regex_15__3_ast_transformed, regex_15__4_generated, regex_15__5_display, regex_after_data05yaml__after_data0_pathyaml, regex_after_data05yaml__after_data1_pre_astyaml, regex_after_data05yaml__after_data2_astyaml, regex_after_data05yaml__after_data3_ast_transformedyaml, regex_after_data05yaml__after_data4_generatedyaml, regex_after_data05yaml__after_data5_displayyaml, ERR, wordwrap) {
    var regex_15 = {
        by_file: {},
        by_folder: {} };
    ...
    var _ = function _() {
        ...
        var expected = module_lodashfp.values(regex_after_data05yaml.by_file);
        return local_include_sharedconcat_promises('conveyor_to_display tests', module_lodashfp.map(module_lodashfp.values(steps), function (promise, index) {
            return promise(expected[index]).then(function (result) {
                var ret = local_include_sharedtest_compare(module_lodashfp.keys(steps)[index], expected[index + 1], result);
                return ret;
