...
gulp.task('build_lambda_pattern_tool', function () {
    return gulp.src('lambda_pattern.js').pipe(webpack({
        target: 'node',
        output: {
...
gulp.task('build_release', sequence('copy_src', 'es6', 'tools_es6', 'main_file', 'build_tools', 'send_built_tools_to_release'));
