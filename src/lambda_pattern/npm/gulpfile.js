...
gulp.task('copy_yaml_to_release', function () {
    return gulp.src(['lambda_pattern/shared/default_package_values.yaml', 'lambda_pattern/shared/package_template.json']).pipe(debug()).pipe(gulp.dest('../../release/lambda_pattern/shared'));
});
...
gulp.task('build', sequence('copy_skel_to_parent', 'es6', 'tools_es6', 'main_file', 'backup_gulpfile', 'build_updatables', 'build_lambda_pattern_tool', 'copy_skel_to_release', 'copy_yaml_to_release'));
