...
gulp.task('build_lambda_pattern_tool', function () {
    return gulp.src('src/lambda_pattern/lambda_pattern.js').pipe(webpack({ target: 'node', output: { filename: 'lambda_pattern_tool_built.js' } })).pipe(gulp.dest('src/lambda_pattern'));
});

gulp.task('build_dev', sequence('copy_src', 'es6', 'main_file', 'backup_gulpfile', 'build_tools', 'build_lambda_pattern_tool'));
