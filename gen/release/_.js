...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = q.all(promises).spread(function (local_include_sharedcopy_if_exists, local_include_sharedmove_if_exists, local_include_sharedconvert_es6, local_include_modify_es6, local_include_webpack, ERR, wordwrap) {
	  var copy_if_exists, move_if_exists, convert_es6, _;
	  copy_if_exists = local_include_sharedcopy_if_exists;
...
/***/ function(module, exports) {
	...
	var promises = [
	// load jspm
	jspm.import('gulp@^3.9.1'), jspm.import('gulp-babel@^6.1.2'), jspm.import('continuation@^0.1.7'),
	// other
	jspm.import('async-stacktrace'), jspm.import('wordwrap')];
	module.exports = q.all(promises).spread(function (module_gulp391, module_gulpbabel612, module_continuation017, ERR, wordwrap) {
...
/***/ function(module, exports) {
	...
	var promises = [
	// load jspm
	jspm.import('gulp@^3.9.1'), jspm.import('gulp-insert@^0.5.0'),
	// other
	jspm.import('async-stacktrace'), jspm.import('wordwrap')];
	module.exports = q.all(promises).spread(function (module_gulp391, module_gulpinsert050, ERR, wordwrap) {
	    var _ = function _(root_path, cb) {
...
/***/ function(module, exports) {
	...
	var promises = [
	// load jspm
	jspm.import('gulp@^3.9.1'), jspm.import('webpack-stream@^3.2.0'), jspm.import('webpack-node-externals@^1.5.4'), jspm.import('gulp-insert@^0.5.0'),
	// other
	jspm.import('async-stacktrace'), jspm.import('wordwrap')];
	module.exports = q.all(promises).spread(function (module_gulp391, module_webpackstream320, module_webpacknodeexternals154, module_gulpinsert050, ERR, wordwrap) {
	    var _ = function _(root_path, cb) {
	        module_gulp391.task('_', function () {
