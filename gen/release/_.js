...
/***/ function(module, exports, __webpack_require__) {
	...
	var promises = [
	// load jspm
	jspm.import('vinyl-fs'), jspm.import('map-stream'), jspm.import('continuation@^0.1.7'),
	// load local
	__webpack_require__(15), __webpack_require__(16), __webpack_require__(17),
	// other
	jspm.import('async-stacktrace'), jspm.import('wordwrap')];
	module.exports = q.all(promises).spread(function (module_vinylfs, module_mapstream, module_continuation017, local_include_headertxt, local_include_error_handlertxt, local_include_cb_definetxt, ERR, wordwrap) {
	    var _ = function _(root_path, cb) {
