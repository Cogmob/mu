...
/***/ function(module, exports, __webpack_require__) {
	...
	__sharedget_metadata = __webpack_require__(7);
	__set_up_ = __webpack_require__(9);
	__build_tools_ = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm, copy_path, read_file, write_file, ERR, word_wrap, _;
	'use strict';
	jspm = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	copy_path = jspm.import('fs-extra@^1.0.0').copy;
	read_file = jspm.import('fs-extra@^1.0.0').readFile;
	write_file = jspm.import('fs-extra@^1.0.0').writeFile;
	ERR = __webpack_require__(1);
	word_wrap = __webpack_require__(2);
	_ = function _(mu_src_path, root_path, project_name, year, cb) {
	  ...
	  copy_path(skel_path, gen_path, function (arguments, _$param0) {
	    err = _$param0;
	    if (ERR(err, cb)) {
	      return;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm, read_file, yaml, ERR, word_wrap, _;
	'use strict';
	jspm = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	read_file = jspm.import('fs-extra@^1.0.0').readFile;
	yaml = jspm.import('js-yaml@^3.7.0').undefined;
	ERR = __webpack_require__(1);
	word_wrap = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __set_updatables_version_, __project, __tools, jspm, make_dir, ERR, word_wrap, _;
	'use strict';
	__set_updatables_version_ = __webpack_require__(10);
	__project = __webpack_require__(13);
	__tools = __webpack_require__(17);
	jspm = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	make_dir = jspm.import('fs-extra@^1.0.0').mkdirp;
	ERR = __webpack_require__(1);
	word_wrap = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __sharedfind_project_root, jspm, fs, git_archive, tar_fs, ERR, word_wrap, move, find_project_root, _;
	'use strict';
	__sharedfind_project_root = __webpack_require__(11);
	jspm = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	fs = jspm.import('fs-extra@^1.0.0').undefined;
	git_archive = jspm.import('git-archive@^0.1.4').undefined;
	tar_fs = jspm.import('tar-fs@^1.15.0').undefined;
	ERR = __webpack_require__(1);
	word_wrap = __webpack_require__(2);
	move = fs.move;
	...
	_ = function _(mu_src_path, root_path, version, cb) {
	  ...
	  move_updatables = function move_updatables() {
	    ...
	    make_dir(root_path + '/generated_local/updatables', function (arguments, _$param4) {
	      ...
	      fs.create_read_stream(root_path + '/generated_local/updatables.tar').pipe(tar_fs.extract(root_path + '/generated_local/updatables')).on('finish', cleanup).on('error', function (er) {
	        return ERR(er, cb);
	      });
	    }.bind(this, arguments));
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm, file_exists, ERR, word_wrap, _;
	'use strict';
	jspm = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	file_exists = jspm.import('fs-extra@^1.0.0').stat;
	ERR = __webpack_require__(1);
	word_wrap = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __sharedcopy_if_exists, __set_updatables_version_, __sharedmake_package_json, jspm, yaml, ERR, word_wrap, copy_if_exists, _;
	'use strict';
	__sharedcopy_if_exists = __webpack_require__(14);
	__set_updatables_version_ = __webpack_require__(10);
	__sharedmake_package_json = __webpack_require__(15);
	jspm = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	yaml = jspm.import('js-yaml@^3.7.0').undefined;
	ERR = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load jspm
	var jspm = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	var fs = jspm.import('fs-extra@^1.0.0').undefined;
	// imports for all files
	var ERR = __webpack_require__(1);
	var word_wrap = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm, ramda, read_file, js_yaml, object_merge_override, string_template, write_file, ERR, word_wrap, _;
	'use strict';
	jspm = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	ramda = jspm.import('ramda');
	read_file = jspm.import('fs-extra@^1.0.0').readFile;
	js_yaml = jspm.import('js_yaml');
	object_merge_override = jspm.import('object-merge-override@^0.1.0').undefined;
	string_template = jspm.import('string-template@^1.0.0').undefined;
	write_file = jspm.import('fs-extra@^1.0.0').writeFile;
	ERR = __webpack_require__(1);
	word_wrap = __webpack_require__(2);
	_ = function _(mu_src_path, metadata, gen_path, deps, dev_deps, cb) {
	  ...
	  read_file(mu_src_path + '/lambda_pattern/shared/default_package_values.yaml', 'utf8', function (arguments, _$param0, _$param1) {
	    ...
	    def_vals = js_yaml.safeLoad(def_vals_yaml);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __sharedcopy_if_exists, __sharedmake_package_json, jspm, child_process, ERR, word_wrap, copy_if_exists, make_package_json, _;
	'use strict';
	__sharedcopy_if_exists = __webpack_require__(14);
	__sharedmake_package_json = __webpack_require__(15);
	jspm = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	child_process = jspm.import('child_process');
	ERR = __webpack_require__(1);
	word_wrap = __webpack_require__(2);
	copy_if_exists = __sharedcopy_if_exists;
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	__sharedcopy_if_exists = __webpack_require__(14);
	__sharedmove_if_exists = __webpack_require__(19);
	__sharedconvert_es6 = __webpack_require__(20);
	__modify_es6 = __webpack_require__(21);
	__webpack = __webpack_require__(23);
	ERR = __webpack_require__(1);
	word_wrap = __webpack_require__(2);
	copy_if_exists = __sharedcopy_if_exists;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	var move_path = jspm.import('fs-extra@^1.0.0').move;
	// imports for all files
	var ERR = __webpack_require__(1);
	var word_wrap = __webpack_require__(2);
	var _ = function _(from, to, cb) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	var gulp = jspm.import('gulp@^3.9.1').undefined;
	;
	var gulp_babel = jspm.import('gulp-babel@^6.1.2').undefined;
	var continuation = jspm.import('continuation@^0.1.7').undefined;
	;
	;
	// imports for all files
	var ERR = __webpack_require__(1);
	...
	var _ = function _(root_path, cb) {
	    gulp.task('_', function () {
	        return gulp.src([root_path + '/**/*.es6', '!**/expected/**', '!**/node_modules/**', '!**/*_data/**/*']).pipe(gulp_babel({ presets: ['es2015'] })).pipe(continuation()).pipe(gulp.dest(root_path)).on('end', cb).on('error', cb);
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gulp = jspm.import('gulp@^3.9.1').undefined;
	;
	var webpack_stream = jspm.import('webpack-stream@^3.2.0').undefined;
	var webpack_node_externals = jspm.import('webpack-node-externals@^1.5.4').undefined;
	var gulp_insert = jspm.import('gulp-insert@^0.5.0').undefined;
	;
	;
	// imports for all files
	...
	var _ = function _(root_path, cb) {
	    gulp.task('_', function () {
	        ...
	        return gulp.src(root_path + '/_.js').pipe(webpack_stream({
	            context: root_path,
	            ...
	            target: 'node' })).pipe(gulp_insert.prepend('#!/usr/bin/env node\n\n')).pipe(gulp.dest(root_path)).on('end', cb).on('error', cb);
	    });
