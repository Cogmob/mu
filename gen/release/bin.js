...
/***/ function(module, exports, __webpack_require__) {
	...
	// load local
	var local_include_create__commander = __webpack_require__(1);
	// load jspm
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm, word_wrap, ERR, local_include__, local_include_sharedget_metadata, local_include_set_up_, local_include_build_tools_, _;
	'use strict';
...
/***/ function(module, exports) {
	...
	var jspm, word_wrap, ERR, module_fsextra100, import_copy_pathcopy, import_read_filereadFile, import_write_filewriteFile, _;
	'use strict';
	jspm = eval('require')(process.env['HOME'] + '/.jspm_global_packages/node_modules/jspm/api.js');
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	word_wrap = jspm.import('word-wrap');
...
/***/ function(module, exports) {
	...
	var jspm, word_wrap, ERR, module_fsextra100, module_jsyaml370, import_read_filereadFile, _;
	'use strict';
	jspm = eval('require')(process.env['HOME'] + '/.jspm_global_packages/node_modules/jspm/api.js');
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	word_wrap = jspm.import('word-wrap');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm, word_wrap, ERR, local_include_set_updatables_version_, local_include_project, local_include_tools, module_fsextra100, import_make_dirmkdirp, _;
	'use strict';
	jspm = eval('require')(process.env['HOME'] + '/.jspm_global_packages/node_modules/jspm/api.js');
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	word_wrap = jspm.import('word-wrap');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm, word_wrap, ERR, local_include_sharedfind_project_root, module_fsextra100, module_gitarchive014, module_tarfs1150, move, find_project_root, _;
	'use strict';
	jspm = eval('require')(process.env['HOME'] + '/.jspm_global_packages/node_modules/jspm/api.js');
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	word_wrap = jspm.import('word-wrap');
...
/***/ function(module, exports) {
	...
	var jspm, word_wrap, ERR, module_fsextra100, import_file_existsstat, _;
	'use strict';
	jspm = eval('require')(process.env['HOME'] + '/.jspm_global_packages/node_modules/jspm/api.js');
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	word_wrap = jspm.import('word-wrap');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm, word_wrap, ERR, local_include_sharedcopy_if_exists, local_include_set_updatables_version_, local_include_sharedmake_package_json, module_jsyaml370, copy_if_exists, _;
	'use strict';
	jspm = eval('require')(process.env['HOME'] + '/.jspm_global_packages/node_modules/jspm/api.js');
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	word_wrap = jspm.import('word-wrap');
...
/***/ function(module, exports) {
	...
	var ERR = jspm.import('async-stacktrace');
	// load jspm
	var module_fsextra100 = jspm.import('fs-extra@^1.0.0');
...
/***/ function(module, exports) {
	...
	var jspm, word_wrap, ERR, module_ramda, module_fsextra100, module_js_yaml, module_objectmergeoverride010, module_stringtemplate100, import_read_filereadFile, import_write_filewriteFile, _;
	'use strict';
	jspm = eval('require')(process.env['HOME'] + '/.jspm_global_packages/node_modules/jspm/api.js');
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	word_wrap = jspm.import('word-wrap');
	...
	module_fsextra100 = jspm.import('fs-extra@^1.0.0');
	module_js_yaml = jspm.import('js_yaml');
	...
	_ = function _(mu_src_path, metadata, gen_path, deps, dev_deps, cb) {
	  ...
	  import_read_file(mu_src_path + '/lambda_pattern/shared/default_package_values.yaml', 'utf8', function (arguments, _$param0, _$param1) {
	    ...
	    def_vals = module_js_yaml.safeLoad(def_vals_yaml);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm, word_wrap, ERR, local_include_sharedcopy_if_exists, local_include_sharedmake_package_json, copy_if_exists, make_package_json, _;
	'use strict';
	jspm = eval('require')(process.env['HOME'] + '/.jspm_global_packages/node_modules/jspm/api.js');
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	word_wrap = jspm.import('word-wrap');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspm, word_wrap, ERR, local_include_sharedcopy_if_exists, local_include_sharedmove_if_exists, local_include_sharedconvert_es6, local_include_modify_es6, local_include_webpack, copy_if_exists, move_if_exists, convert_es6, _;
	'use strict';
	jspm = eval('require')(process.env['HOME'] + '/.jspm_global_packages/node_modules/jspm/api.js');
	jspm.setPackagePath(process.env['HOME'] + '/.jspm_global_packages');
	word_wrap = jspm.import('word-wrap');
...
/***/ function(module, exports) {
	...
	var ERR = jspm.import('async-stacktrace');
	// load jspm
	var module_gulp391 = jspm.import('gulp@^3.9.1');
	var module_gulpbabel612 = jspm.import('gulp-babel@^6.1.2');
	var module_continuation017 = jspm.import('continuation@^0.1.7');
...
/***/ function(module, exports) {
	...
	// load jspm
	var module_gulp391 = jspm.import('gulp@^3.9.1');
	var module_gulpinsert050 = jspm.import('gulp-insert@^0.5.0');
	var _ = function _(root_path, cb) {
...
/***/ function(module, exports) {
	...
	// load jspm
	var module_gulp391 = jspm.import('gulp@^3.9.1');
	var module_webpackstream320 = jspm.import('webpack-stream@^3.2.0');
	var module_webpacknodeexternals154 = jspm.import('webpack-node-externals@^1.5.4');
	var module_gulpinsert050 = jspm.import('gulp-insert@^0.5.0');
	var _ = function _(root_path, cb) {
	    module_gulp391.task('_', function () {
